...
#copied from regression-examples
...
tidy_eyes_binomial <- tidy(eyes_binomial, conf.int = TRUE)

tidy_eyes_poisson <- tidy(eyes_poisson, conf.int = TRUE)

dplyr::bind_rows(
	eyes_binomial = tidy_eyes_binomial,
	eyes_poisson = tidy_eyes_poisson) |>
